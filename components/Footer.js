...
import IntaSend from "../public/intasend.png";
        ...
        <div className=" flex flex-col items-center justify-center">
          ...
          {/* <span style={"display:block; text-align: center"}>
            <a href="https://intasend.com/security" target="_blank">
              <Image src="https://intasend-prod-static.s3.amazonaws.com/img/trust-badges/intasend-trust-badge-no-mpesa-hr-dark.png" height={300} width={375} alt="IntaSend Secure Payments (PCI-DSS Compliant)" />
            </a>
            <strong>
              <a style="display: block; color: #fafafa; text-decoration: none; font-size: 0.8em; margin-top: 0.6em;" href="https://intasend.com/security" target="_blank">
